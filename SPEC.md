...
Могут иметь нагрузку (количество задач на фазу, необязательное свойство фаз), и название. 
...
**Фаза** *(column)* - имеет название, порядок(порядок отображения в списке всех столбцов), и показатель максимальной нагрузки(максимальное количество задач на фазу).
